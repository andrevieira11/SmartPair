...
export type PlanId = "basic" | "student" | "pro" | "premium";
...
export const PLANS: Plan[] = [
  {
    ...
    tagline: "Free",
    priceMonthly: 0,
    tutorTier: "Available tutors (under-18 or university students)",
    included: "15 min of trial class per week",
    perks: [
      "15 trial minutes / week",
      "No subject specialization guarantee",
      "Extra minutes at €0.30/min",
      "Notes & past exams",
      "Study communities",
    ],
    ideal: "Anyone wanting to try it out or with very light usage",
  },
  {
    id: "student",
    name: "Student",
    ...
    priceMonthly: 9.99,
    tutorTier: "Subject specialist tutor",
    included: "3 lessons / month · up to 45 min each",
    highlight: true,
    perks: [
      "3 lessons / month with a specialist",
      "Up to 45 min per lesson",
      "15% off extra lessons",
      "Priority matching",
      "Everything in Basic",
    ],
    ideal: "Students with regular needs and a tight budget",
  },
  {
    id: "pro",
    name: "Pro",
    tagline: "For exams",
    priceMonthly: 24.99,
    tutorTier: "Certified teacher",
    included: "3 lessons / month · up to 60 min each",
    perks: [
      "3 lessons / month with a certified teacher",
      "Up to 60 min per lesson",
      "25% off extra lessons",
      "Instant match (highest priority)",
      "Study materials included",
      "Lesson recording (optional)",
    ],
    ideal: "Exam prep or complex difficulties",
  },
  {
    id: "premium",
    name: "Premium",
    tagline: "Full coaching",
    priceMonthly: 49.99,
    tutorTier: "Premium teacher (rating > 4.7)",
    included: "5 lessons / month · up to 90 min each",
    perks: [
      "5 lessons / month with a premium teacher",
      "Up to 90 min per lesson",
      "Instant match — top of the queue",
      "Personalized study plan",
      "Auto recording of every lesson",
      "Monthly progress report",
    ],
    ideal: "Continuous coaching and ambitious goals",
  },
];
